...
namespace TMDT.Areas.Admin.Controllers
{
    public class KhuyenMaisController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdKM,Mota,MucKM,NgayBD,NgayKT")] KhuyenMai khuyenMai)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdKM,Mota,MucKM,NgayBD,NgayKT")] KhuyenMai khuyenMai)
        {
            if (ModelState.IsValid)
            {
